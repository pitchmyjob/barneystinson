...
class JobAdmin(admin.ModelAdmin):
    fields = ('pro', 'title', 'contract_types', 'experiences', 'study_levels', 'salary', 'skills', 'description',
              'view_counter', 'last_payment', 'is_complete', 'is_active')
    filter_horizontal = ('contract_types', 'experiences', 'study_levels')
    list_display = ('pro', 'title', 'is_complete', 'is_active', 'last_payment')
    list_filter = ('is_complete', 'is_active', 'contract_types', 'experiences', 'study_levels')
